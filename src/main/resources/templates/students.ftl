     ...
     <div class="row">
       ...
       <div class="col-md-8">      
         <table class="table table-hover">
           <thead>
           <th>ID</th><th>姓名</th><th>年龄</th><th>性别</th><th>头像</th><th>删除</th><th>修改</th><th>头像</th>
           </thead>
           <tbody>
           <#list students as student>
           <tr>
           <td>${student.id}</td><td>${student.name}</td><td>${student.age}</td><td>${student.sex}</td><td>${student.avatar}</td>
